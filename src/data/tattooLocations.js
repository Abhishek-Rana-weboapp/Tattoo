...
export const piercingBodyLocations = [
   {id:"Belly Piercing", label:"belly piercing" , parentId:null, level:1}, 
   {id:"nipple-piercing", label:"Nipple Piercing" , parentId:null, level:1}, 
   ...
   {id:"Regular Earlobe", label:"Regular Earlobe" , parentId:"ear-piercing", level:2}, 
   {id:"Upper Earlobe", label:"Upper Earlobe" , parentId:"ear-piercing", level:2}, 
   {id:"Industrial", label:"Industrial" , parentId:"ear-piercing", level:2}, 
   {id:"Tragus", label:"Tragus" , parentId:"ear-piercing", level:2}, 
   {id:"Rook", label:"Rook" , parentId:"ear-piercing", level:2}, 
   {id:"Conch", label:"Conch" , parentId:"ear-piercing", level:2}, 
   {id:"Daith", label:"Daith" , parentId:"ear-piercing", level:2}, 
   {id:"Snug", label:"Snug" , parentId:"ear-piercing", level:2}, 
   {id:"Forward Helix", label:"Forward Helix" , parentId:"ear-piercing", level:2}, 
   {id:"Helix", label:"Helix" , parentId:"ear-piercing", level:2}, 
   {id:"Anti Helix", label:"Anti Helix" , parentId:"ear-piercing", level:2}, 
   {id:"Anti Tragus", label:"Anti Tragus" , parentId:"ear-piercing", level:2}, 
   {id:"Auricle", label:"Auricle" , parentId:"ear-piercing", level:2}, 
   {id:"External Auditory Meatus", label:"External Auditory Meatus" , parentId:"ear-piercing", level:2}, 
   {id:"Transverse Lobe", label:"Transverse Lobe" , parentId:"ear-piercing", level:2}, 


   {id:"Cheek", label:"Cheek" , parentId:"facial-piercing", level:2}, 
   {id:"Eyebrow", label:"Eyebrow" , parentId:"facial-piercing", level:2}, 
   {id:"sideburn", label:"sideburn" , parentId:"facial-piercing", level:2}, 
   ...
   {id:"Septum", label:"Septum" , parentId:"nose-piercing", level:2}, 
   {id:"Austin Bar", label:"Austin Bar" , parentId:"nose-piercing", level:2}, 
   {id:"Erl", label:"Erl" , parentId:"nose-piercing", level:2}, 
   {id:"High Nostril 19g", label:"High Nostril" , parentId:"nose-piercing", level:2}, 
   {id:"Nostril Nasallang", label:"Nostril Nasallang" , parentId:"nose-piercing", level:2}, 
   {id:"Rhino", label:"Rhino" , parentId:"nose-piercing", level:2}, 
   {id:"Septril", label:"Septril" , parentId:"nose-piercing", level:2}, 
   {id:"Third Eye", label:"Third Eye" , parentId:"nose-piercing", level:2}, 



   { id: "Straight Bar Tongue", label: "Straight Bar Tongue", parentId: "oral-piercing", level: 2 },
  { id: "Snake Eye Tongue", label: "Snake Eye Tongue", parentId: "oral-piercing", level: 2 },
  { id: "Snake Bite Lip", label: "Snake Bite Lip", parentId: "oral-piercing", level: 2 },
  { id: "Tongue Web", label: "Tongue Web", parentId: "oral-piercing", level: 2 },
  { id: "Smiley", label: "Smiley", parentId: "oral-piercing", level: 2 },
  { id: "Monroe", label: "Monroe", parentId: "oral-piercing", level: 2 },
  { id: "Medusa", label: "Medusa", parentId: "oral-piercing", level: 2 },
  { id: "Madonna", label: "Madonna", parentId: "oral-piercing", level: 2 },
  { id: "Dimples", label: "Dimples", parentId: "oral-piercing", level: 2 },
  { id: "Ashley", label: "Ashley", parentId: "oral-piercing", level: 2 },
  { id: "Angel Bites", label: "Angel Bites", parentId: "oral-piercing", level: 2 },
  { id: "Canine Bites", label: "Canine Bites", parentId: "oral-piercing", level: 2 },
  { id: "Cyber Bites", label: "Cyber Bites", parentId: "oral-piercing", level: 2 },
  { id: "Dahlia", label: "Dahlia", parentId: "oral-piercing", level: 2 },
  { id: "Dolphin Bites", label: "Dolphin Bites", parentId: "oral-piercing", level: 2 },
  { id: "Frowney", label: "Frowney", parentId: "oral-piercing", level: 2 },
  { id: "Gum", label: "Gum", parentId: "oral-piercing", level: 2 },
  { id: "Horizontal Lip", label: "Horizontal Lip", parentId: "oral-piercing", level: 2 },
  { id: "Jestrum", label: "Jestrum", parentId: "oral-piercing", level: 2 },
  { id: "Multi Tongue", label: "Multi Tongue", parentId: "oral-piercing", level: 2 },
  { id: "Shark Bites", label: "Shark Bites", parentId: "oral-piercing", level: 2 },
  { id: "Spider Bites", label: "Spider Bites", parentId: "oral-piercing", level: 2 },
  { id: "Vampire", label: "Vampire", parentId: "oral-piercing", level: 2 },
  { id: "Venom", label: "Venom", parentId: "oral-piercing", level: 2 },
  { id: "Vertical Labret", label: "Vertical Labret", parentId: "oral-piercing", level: 2 },


    { id: "Arm", label: "Arm", parentId: "surface-piercing", level: 2 },
  { id: "Back", label: "Back", parentId: "surface-piercing", level: 2 },
  { id: "Chest", label: "Chest", parentId: "surface-piercing", level: 2 },
  { id: "Face", label: "Face", parentId: "surface-piercing", level: 2 },
  { id: "Finger", label: "Finger", parentId: "surface-piercing", level: 2 },
  { id: "Foot", label: "Foot", parentId: "surface-piercing", level: 2 },
  { id: "Hand", label: "Hand", parentId: "surface-piercing", level: 2 },
  { id: "Hip", label: "Hip", parentId: "surface-piercing", level: 2 },
  { id: "Leg", label: "Leg", parentId: "surface-piercing", level: 2 },
  { id: "Neck", label: "Neck", parentId: "surface-piercing", level: 2 },
  { id: "Pelvic", label: "Pelvic", parentId: "surface-piercing", level: 2 },
  { id: "Ribs", label: "Ribs", parentId: "surface-piercing", level: 2 },
  { id: "Shoulder", label: "Shoulder", parentId: "surface-piercing", level: 2 },
  { id: "Stomach", label: "Stomach", parentId: "surface-piercing", level: 2 },
