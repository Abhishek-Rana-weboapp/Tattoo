...
//   useEffect(() => {
//     if (appointment?.beforeImage) {
//       setUploadedUrls(decodeUrls(appointment.beforeImage));
//       setSelected("yes")
//     }

//     if (appointment.video_url) {
//       setUploadedVideoUrl(decodeUrls(appointment.beforeVideo));
//       setSelected("yes")
//     }
//   }, []);
...
//   //         setLoading(false);
//   //         navigate(
//   //           `/billing/${appointment?.id}/${res.data.updatedtable.process_step}`
//   //         );
//   //       })
//   //       .catch((err) => {
//   //         setLoading(false);
...
//   //       });
//   //   } else {
//   //     if(appointment.typeofservice === "tattoo"  && selected === "no"){
//   //        data = {
//   //         updates: [
//   //           {
//   //             id: appointment?.id,
